...
## Miscellaneous
If you are interested in more detailed guide on how to develop a `deviceshifu`, you can reference to the PR below on how we created `deviceshifupcl4x`, a deviceshifu that utilizes pcl4x library.
https://github.com/Edgenesis/shifu/pull/275/files