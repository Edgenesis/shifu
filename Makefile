...
build-image-deviceshifu:
	docker build -f ${PROJECT_ROOT}/deviceshifu/Dockerfile.deviceshifu --build-arg PROJECT_ROOT="${PROJECT_ROOT}/deviceshifu" ${PROJECT_ROOT} -t edgehub/deviceshifu-http:${IMAGE_VERSION}
