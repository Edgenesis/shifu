...
func (in *GatewaySettings) DeepCopyInto(out *GatewaySettings) {
	*out = *in
	...
	if in.NATSSetting != nil {
		in, out := &in.NATSSetting, &out.NATSSetting
		*out = new(NATSSetting)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NATSSetting) DeepCopyInto(out *NATSSetting) {
	*out = *in
	if in.Reconnect != nil {
	...
	if in.MaxReconnectTimes != nil {
		in, out := &in.MaxReconnectTimes, &out.MaxReconnectTimes
		*out = new(int)
		**out = **in
	}
	if in.ReconnectWaitSec != nil {
		in, out := &in.ReconnectWaitSec, &out.ReconnectWaitSec
		*out = new(int)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NATSSetting.
func (in *NATSSetting) DeepCopy() *NATSSetting {
	if in == nil {
		return nil
	}
	out := new(NATSSetting)
