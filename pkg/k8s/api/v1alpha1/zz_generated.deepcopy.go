...
func (in *ConnectionSetting) DeepCopyInto(out *ConnectionSetting) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionSetting.
func (in *ConnectionSetting) DeepCopy() *ConnectionSetting {
	if in == nil {
		return nil
	}
	out := new(ConnectionSetting)
	in.DeepCopyInto(out)
	return out
}
