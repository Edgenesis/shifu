...
func main() {
	...
	// this setup is not recommended for production use because the self-signed certificate only includes
	// localhost/127.0.0.1 as SANs, which will cause x509 errors when Prometheus scrapes via the service DNS name.
	//
	// For production: Enable cert-manager integration by uncommenting the following:
	// - [CERTMANAGER] at config/default/kustomization.yaml: resources section (line 25)
	// - [METRICS-WITH-CERTS] at config/default/kustomization.yaml: patches section (line 47-49)
	// - [CERTMANAGER] at config/default/kustomization.yaml: replacements section (line 59-118)
	// - [PROMETHEUS-WITH-CERTS] at config/prometheus/kustomization.yaml for TLS certification.
	// Then regenerate manifests with: make generate-controller-yaml
